...
###
### There are slight modifications to make this work with the NNI framework
### There is different syntax for Multi-Trial (MT) and OneShot (OS) search
### This is the MT version
###


class EvalLandmarkOS(LightningModule):
    def __init__(
                 self, 
                 learning_rate=0.001,
                 mode="pretrain2",
    ...
    def validation_step(self, batch, batch_idx):
        ...
        # logging for lightning and nni
        self.log('validation_loss', self.validation_loss, prog_bar=False) # this acts up if you use a jupyter notebook, if you use a python script it works fine
    ...
    def validation_epoch_end(self, *args, **kwargs):
        if self.current_epoch % self.log_every == 0 and self.current_epoch != 0:     
            report_intermediate_result({
                 ...
                 'validation_loss': round(self.validation_loss.item(),5),
                })
